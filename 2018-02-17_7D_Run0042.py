...
'''
Trains 7D QuaLiKiz-NN with a single output (pfiITG)
'''
...
target_df = store['pfiITG_GB'].to_frame()  # This one is relatively easy to train
...
shuffled_clean_output_df = shuffled_joined_dataFrame['pfiITG_GB']

# Creates a pandas dataframe for the inputs
shuffled_clean_input_df = shuffled_joined_dataFrame.drop('pfiITG_GB', axis=1)
