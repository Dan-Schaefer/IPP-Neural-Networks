...
model = Sequential()
model.add(Dense(30, activation='tanh', kernel_initializer=TruncatedNormal(mean=0.0, stddev=0.05, seed=None), kernel_regularizer=regularizers.l2(), input_shape=(7,)))
model.add(Dense(30, activation='tanh', kernel_initializer=TruncatedNormal(mean=0.0, stddev=0.05, seed=None), kernel_regularizer=regularizers.l2()))
model.add(Dense(30, activation='tanh', kernel_initializer=TruncatedNormal(mean=0.0, stddev=0.05, seed=None), kernel_regularizer=regularizers.l2()))
