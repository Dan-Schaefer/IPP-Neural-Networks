...
target_df = store['efiTEM_GB'].to_frame()  # This one is relatively easy to train
...
joined_dataFrame = joined_dataFrame[(joined_dataFrame['efiTEM_GB']>0)
...
shuffled_clean_input_df = shuffled_joined_dataFrame.drop('efiTEM_GB', axis=1)
