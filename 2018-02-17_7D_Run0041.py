...
'''
Trains 7D QuaLiKiz-NN with a single output (efeITG)
'''
...
target_df = store['efeITG_GB'].to_frame()  # This one is relatively easy to train
...
joined_dataFrame = joined_dataFrame[(joined_dataFrame['efeITG_GB']>0)
...
shuffled_clean_output_df = shuffled_joined_dataFrame['efeITG_GB']

# Creates a pandas dataframe for the inputs
shuffled_clean_input_df = shuffled_joined_dataFrame.drop('efeITG_GB', axis=1)
