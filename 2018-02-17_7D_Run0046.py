...
'''
Trains 7D QuaLiKiz-NN with a single output (efeTEM)
'''
...
target_df = store['efeTEM_GB'].to_frame()  # This one is relatively easy to train
...
joined_dataFrame = joined_dataFrame[(joined_dataFrame['efeTEM_GB']>0)
...
shuffled_clean_output_df = shuffled_joined_dataFrame['efeTEM_GB']

# Creates a pandas dataframe for the inputs
shuffled_clean_input_df = shuffled_joined_dataFrame.drop('efeTEM_GB', axis=1)
