...
'''
Trains 7D QuaLiKiz-NN with a single output (vfiITG)
'''
...
target_df = store['vfiITG_GB'].to_frame()  # This one is relatively easy to train
...
joined_dataFrame = joined_dataFrame[(joined_dataFrame['vfiITG_GB']>0)
...
shuffled_clean_output_df = shuffled_joined_dataFrame['vfiITG_GB']

# Creates a pandas dataframe for the inputs
shuffled_clean_input_df = shuffled_joined_dataFrame.drop('vfiITG_GB', axis=1)
