...
store = pandas.HDFStore("\\draco\\u\\danis\\Keras"
...
# Add TensorBoard
tbCallBack = keras.callbacks.TensorBoard(log_dir='\\draco\\u\\danis\\Keras\\TensorBoard_logs', write_graph=True)
...
model.save("\\draco\\u\\danis\\Keras\\2018-01-27_7D_efiITG_GB_5HiddenLayer_RELU_Dropout_2000Epochs_DracoTest3.h5")
